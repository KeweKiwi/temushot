      ...
      <Reveal className="section-shell">
        ...
        <div className="warm-card grid gap-7 rounded-[2rem] p-5 md:grid-cols-[0.85fr_0.95fr_0.9fr] md:p-8 lg:p-10">
          <div className="grid content-center gap-4">
            <div className="rounded-[1.5rem] bg-gradient-to-br from-orange to-saffron p-5 text-white shadow-glow">
            ...
            {details.map(([label, value], index) => (
              <Reveal key={label} delay={index * 0.04} className="flex items-center gap-3 rounded-2xl bg-cream/80 p-4">
          ...
          <div className="relative aspect-square self-center overflow-hidden rounded-[1.5rem] bg-cocoa shadow-soft">
            <Image
              src="/images/temushot1.png"
              alt="Temu Shot dengan temulawak, daun herbal, dan bubuk rempah"
              fill
          ...
          <div className="rounded-[1.5rem] bg-butter/45 p-6">
